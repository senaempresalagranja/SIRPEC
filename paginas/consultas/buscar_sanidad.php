...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Consultar Sanidad</h1>
	</div>
		<div class="container">
			<br>
			<br>
...
$query="SELECT sanidad.idProducto, producto.nombre FROM `sanidad` INNER JOIN producto ON sanidad.idProducto=producto.idProducto GROUP BY sanidad.idProducto, producto.nombre";
...
function consulta_automatica() {
	...
	$("#resultado").load("consultar_sanidad.php",{id:id})
}
		</script>
</html>
