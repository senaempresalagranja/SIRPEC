...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Consultar Estanques</h1>
				</div>
		<div class="container">
			<div class="row">
...
$query="SELECT * FROM finca INNER JOIN estanque ON estanque.idFinca=finca.idFinca";
...
?>
				...
				<div id="resultado" class="col-md-8"></div>
			</div>
		</div>
</body>
<style>
...
function consulta_automatica() {
	...
	$("#resultado").load("consultar_estanque.php",{id:id})
}
		</script>
</html>
