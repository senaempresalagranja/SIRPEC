...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('F5', 'NUMERO ')
            ->setCellValue('G5', 'PESO ')
            ->setCellValue('H5', 'UNIDAD_MEDIDA')
...
//             ->setCellValue('D6', $hora )
//             ->setCellValue('E6',$Fecha )
//             ->setCellValue('F6',$Numero )
//             ->setCellValue('G6', $Peso )
//             ->setCellValue('H6',$Unidad_medida )
...
header('Content-Disposition: attachment;filename="exportacion_muestreo.xlsx"');
