...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C5', 'TOTAL-ESPEJO-AGUA')
            ->setCellValue('D5', 'PROFUNDIDA PROMEDIO')
            ->setCellValue('E5', 'VOLUMEN AGUA')
            ->setCellValue('F5', 'OBSERVACION');
...
$query="SELECT `idEstanque`, finca.nombreFinca, `numeroEstanque`, `totEspejoAgua`, `profundPromedio`, `volumAgua`, `observacion` FROM `estanque` inner join finca on estanque.idFinca=finca.idFinca";
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('EXPORTAR_ESTANQUE');
...
header('Content-Disposition: attachment;filename="exportacion_estanques.xlsx"');
