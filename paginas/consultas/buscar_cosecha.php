...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Consultar Cosecha</h1>
	</div>
		<div class="container">
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<div class="form-group">
						<div id="elemento_buscar">
							<label for="">Seleccionar Cosecha</label>
...
function consulta_automatica() {
	...
	$("#resultado").load("consultar_cosecha.php",{id:id})
