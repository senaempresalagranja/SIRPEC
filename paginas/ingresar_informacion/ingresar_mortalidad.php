...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Ingresar Mortalidad</h1>
	</div>
		<div class="container">
...
// echo "</select>";
 ...
 ?>
				...
				<div class="col-md-10">
                <div class="col-md-5"></div>
                <a onclick="enviar()" title="Registrar Mortalidad" class="icon-button floppy-o"><i class="fa fa-floppy-o"></i><span></span></a>
				<a onclick="nuevo_registro()" title="Nuevo Registro" class="icon-button share"><i class="fa fa-share"></i><span></span></a>
				<a onclick="Actualizar()" title="Actualizar Mortalidad" class="icon-button refresh"><i class="fa fa-refresh"></i><span></span></a>
				<a onclick="consultar_modal()" title="Consultar Mortalidad" class="icon-button search"><i class="fa fa-search"></i><span></span></a>
				<a title="Exportar Mortalidad Excel" onclick="exportar_excel()" class="icon-button file-excel-o"><i class="fa fa-file-excel-o"></i><span></span></a>
                <a onclick="exportar()" title="Exportar Mortalidad PDF" class="icon-button file-pdf-o"><i class="fa fa-file-pdf-o"></i><span></span></a>
                </div>
...
<h1 class="modal-title text-center">Consultar Mortalidad</h1>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<div class="form-group"><label for="">Buscar Mortalidad</label>
...
$("#contenedor").load("registrar_mortalidad.php",{siembra:siembra,fecha:fecha,Cantidad:Cantidad,Observacion:Observacion});
...
$("#contenedor_fecha").load("mostrar_fecha1.php",{id_siembra:id_siembra})
...
$("#contenedor").load("consultar_mortalidad.php",{id_fecha:id_fecha})
...
$("#contenedor").load("Actualizar_mortalidad.php",{id_fecha:id_fecha,siembra:siembra,fecha:fecha,Cantidad:Cantidad,Observacion:Observacion});
}
...
swal({
  title: "Advertencia",
  text: "Desea Exportar Esta Mortalidad?",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#16e528",
  confirmButtonText: "Solo Este Fomulario",
  cancelButtonText: "No, Todas las Mortalidades",
  closeOnConfirm: true,
  closeOnCancel: true
},
function(isConfirm){
...
var formulario=document.getElementById('formulario').action="exportaciones/exportar_mortalidad.php";
$("#formulario").submit();
	...
	// var hora=document.getElementById("hora").type='button';
  	...
  	var formulario=document.getElementById('formulario').action="exportaciones/exportar_todas_mortalidades.php";
...
function(isConfirm){
  if (isConfirm) {
var formulario=document.getElementById('formulario').action="exportaciones/exportar_mortalidad_excel.php";
var fecha=document.getElementById("fecha").type="text";
...
$("#formulario").submit();
 var fecha=document.getElementById("fecha").type="button";
  	...
  	var formulario=document.getElementById('formulario').action="exportaciones/exportar__todas_mortalidad_excel.php";
