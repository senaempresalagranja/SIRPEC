...
$pdf->SetKeywords('EXPORTAR TRASLADOS');
...
$sql="SELECT  siembra.lote, estanque.numeroEstanque, `numerPece`, traslados.peso, traslados.tamano, traslados.fecha, traslados.observacion FROM `traslados` INNER JOIN siembra ON traslados.idSiembra=siembra.idSiembra INNER JOIN estanque ON traslados.idEstanque=estanque.idEstanque";
...
// NOMBRE DEL ARCHIVO
$pdf->Output('FORMULARIO_TRASLADOS.pdf', 'D');
