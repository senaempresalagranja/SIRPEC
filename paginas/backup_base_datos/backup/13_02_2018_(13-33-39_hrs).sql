...
CREATE TABLE `saldo` (
  `idSaldo` bigint(20) NOT NULL AUTO_INCREMENT,
  `idProducto` bigint(20) NOT NULL,
  `saldo` int(11) NOT NULL,
  PRIMARY KEY (`idSaldo`),
  KEY `idProducto` (`idProducto`),
  CONSTRAINT `saldo_ibfk_1` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON DELETE NO ACTION ON UPDATE CASCADE
