...
<!-- ============================================================================== -->
					<h1 class="help-block text-center ">Consultar Producto</h1>
				</div>
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<div class="form-group">
						<div id="elemento_buscar">
							<label for="">Seleccionar Tipo Producto</label>
							<select name="" onchange="mostrarProductosTipo()" id="tipo" style="text-transform:uppercase" class="form-control">	
...
?> -->
			...
			<div class="row"><div id="resultadoProducto" class="col-md-7"></div>
			</div>
		</div>
</div>
</div>
...
function inicio() {
$("#id").change(consultarProductos);
$("#tipo").change(mostrarProductosTipo);
}

function mostrarProductosTipo() {
	var tipo=document.getElementById("tipo").value;
	$("#resultadoTipo").load("consultarProductoTipo.php",{tipo:tipo})
}

function consultarProductos(){
	var id=document.getElementById("id").value;
	$("#resultadoProducto").load("consultar_producto.php",{id:id})
...
function consulta_automatica() {
	//var id=document.getElementById("id").value;
	var tipo=document.getElementById("tipo").value;
	$("#resultado").load("consultar_producto.php",{tipo:tipo})
}
		</script>
