...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Ingresar Cosecha</h1>
	</div>
		<div class="container">
...
<br>
			...
			<!-- <div class="col-md-5"></div> -->
				<div class="col-xs-12 col-md-4">
					...
					<select name="nom_Finca" class="form-control" onclick="colocar_estanque()" id="finca">
...
<select name="n_siembra" class="form-control" id="siembra">
<option value="Selecciona">Selecciona</option>
...
// echo "<option value='Selecciona'>Selecciona</option>";
$conexion=mysqli_connect($loca,$usuario,$contra,$base);
$query="SELECT * FROM `siembra_estanque` ";
$resource=mysqli_query($conexion,$query);
while ($fila=mysqli_fetch_row($resource)) {
				...
				<div class="col-xs-12 col-md-4">
					<div class="form-group">
						<div  id="elemento_tamaño">
							...
							<input type="date" placeholder="" name="n_fecha" id="fecha" class="form-control">
						</div>
					</div>
				</div>
				<!-- </div> -->
				...
				<div class="col-xs-12 col-md-4">
					<div class="form-group">
						<div  id="elemento_tamaño">
							...
							<input type="button" placeholder="" name="n_hora" id="hora" class="form-control">
						</div>
					</div>
				</div>
				<!-- </div> -->
				...
				<div class="col-xs-12 col-md-4">
					<div class="form-group">
						<div  id="elemento_tamaño">
							...
							<label for="">Cantidad De Peces</label>
							<input type="number" placeholder="" name="can_peces" id="cantidad" class="form-control">
						</div>
					</div>
				</div>
				<!-- </div> -->
				...
				<div class="col-xs-12 col-md-4">
					<div class="form-group">
						<div  id="elemento_tamaño">
							...
							<label for="">Peso Pez Entero</label>
							<input type="number" placeholder="" name="pe_entero" id="peso" class="form-control">
						</div>
					</div>
				</div>
				<!-- </div> -->
				...
				<div class="col-xs-12 col-md-4">
					<div class="form-group">
						<div  id="elemento_tamaño">
							...
							<label for="">Peso Pez Evicerado</label>
							<input type="number" placeholder="" name="pe_evice" id="evicerado" class="form-control">
						</div>
					</div>
				</div>
				<!-- </div> -->
				...
				<div class="col-xs-12 col-md-4">
					<div class="form-group">
						<div  id="elemento_tamaño">
							...
							<textarea placeholder="" name="obervac" id="observacion" class="form-control" cols="2" rows="2"></textarea>
						</div>
					</div>
				</div>
				</div>
...
<br>
                <div class="col-md-5"></div>
                <a onclick="enviar()" title="Registrar Cosecha" class="icon-button floppy-o"><i class="fa fa-floppy-o"></i><span></span></a>
				<a onclick="nuevo_registro()" title="Nuevo Registro" class="icon-button share"><i class="fa fa-share"></i><span></span></a>
				<a onclick="Actualizar()" title="Actualizar Cosecha" class="icon-button refresh"><i class="fa fa-refresh"></i><span></span></a>
				<a onclick="consultar_modal()" title="Consultar Cosecha" class="icon-button search"><i class="fa fa-search"></i><span></span></a>
				<a title="Exportar Cosecha Excel" onclick="exportar_excel()" class="icon-button file-excel-o"><i class="fa fa-file-excel-o"></i><span></span></a>
                <a onclick="exportar()" title="Exportar Cosecha PDF" class="icon-button file-pdf-o"><i class="fa fa-file-pdf-o"></i><span></span></a>
                </div>
...
<h1 class="modal-title text-center">Consultar Cosecha</h1>
...
<div class="container-fluid">
		<div class="row">
		<div class="col-md-12">
			<div class="form-group"><label for="">Buscar Cosecha</label>
<select name="" class="form-control" onclick="consultar_hora()" id="fecha_consulta">
	<option value="Selecciona">Selecciona</option>
...
$conexion=mysqli_connect($loca,$usuario,$contra,$base);
$query="SELECT * from cosecha group by fecha order by fecha";
$resource=mysqli_query($conexion,$query);
while ($fila=mysqli_fetch_row($resource)) {
echo "<option name='' id='' value='$fila[2]'>$fila[2]</option>";
}
...
function enviar() {
	...
	var evicerado=document.getElementById("evicerado").value;
	var observacion=document.getElementById("observacion").value;
	var estanque=document.getElementById("estanque").value;
$("#contenedor").load("registrar_cosecha.php",{estanque:estanque,siembra:siembra,fecha:fecha,hora:hora,cantidad:cantidad,peso:peso,evicerado:evicerado, observacion:observacion  })
...
var estanque=document.getElementById("estanque").value;
$("#capacidad_siembra").load("select_anidados/mostrar_siembra1.php",{estanque:estanque})
}
...
function consultar_hora() {
	...
	$("#contenedor_hora").load("mostrar_fecha_cosecha.php",{fecha_consulta:fecha_consulta});

}

function consultar() {
	var hora_consulta=document.getElementById("hora_consulta").value;
$("#contenedor").load("consulrar_cosecha.php",{hora_consulta:hora_consulta});
}
...
function Actualizar() {
	...
	var observacion=document.getElementById("observacion").value;
	var estanque=document.getElementById("estanque").value;
$("#contenedor").load("Actualizar_cosecha.php",{hora_consulta:hora_consulta,estanque:estanque,siembra:siembra,fecha:fecha,hora:hora,cantidad:cantidad,peso:peso,evicerado:evicerado, observacion:observacion  })
}
...
swal({
  title: "Advertencia",
  text: "Desea Exportar Esta Cosecha?",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#16e528",
  confirmButtonText: "Solo Este Fomulario",
  cancelButtonText: "No, Todas las Cosechas",
  closeOnConfirm: true,
  closeOnCancel: true
},
function(isConfirm){
...
var formulario=document.getElementById('formulario').action="exportaciones/exportar_cosecha.php";
$("#formulario").submit();
...
function(isConfirm){
  if (isConfirm) {
var formulario=document.getElementById('formulario').action="exportaciones/exportar_cosecha_excel.php";

$("#formulario").submit();
 
  } else {
  	var formulario=document.getElementById('formulario').action="exportaciones/exportar__todas_cosechas_excel.php";
