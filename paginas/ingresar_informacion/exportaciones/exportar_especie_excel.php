...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A5', 'NOMBRE COMUN')
            ->setCellValue('B5', 'NOMBRE CIENTIFICO');
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B6', $nombre_cientifico);
...
header('Content-Disposition: attachment;filename="exportacion_especie.xlsx"');
