...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C5', 'NUMERO_PECES')
            ->setCellValue('D5', 'PESO')
            ->setCellValue('E5', 'TAMAÑO')
...
$query="SELECT  siembra.lote, estanque.numeroEstanque, `numerPece`, traslados.peso, traslados.tamano, traslados.fecha, traslados.observacion FROM `traslados` INNER JOIN siembra ON traslados.idSiembra=siembra.idSiembra INNER JOIN estanque ON traslados.idEstanque=estanque.idEstanque";
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('EXPORTAR_TRASLADOS');
