...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Consultar Siembra</h1>
	</div>
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<div class="form-group">
						<div id="elemento_buscar">
							<label for="">Seleccionar Lote</label>
...
$query="SELECT * FROM siembra ORDER BY idSiembra";
...
function consulta_automatica() {
	...
	$("#resultado").load("consultar_siembra.php",{id:id})
}
		</script>
</html>
