...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C5', 'LOTE')
            ->setCellValue('D5', 'CANTIDAD ALEVINES')
            ->setCellValue('E5', 'DENSIDAD')
            ->setCellValue('F5', 'BIOMASA')
            ->setCellValue('G5', 'FECHA')
            ->setCellValue('H5', 'HORA')
...
$query="SELECT `idEspecie`, `idEstanque`, `lote`, `cantidAlevino`, `densidad`, `bioMasa`, `fecha`, `hora`, `peso`, `observacion`  FROM `siembra`";
...
header('Content-Disposition: attachment;filename="exportacion_siembras.xlsx"');
