...
$pdf->SetKeywords('EXPORTAR INSUMOS');
...
$sql="SELECT  producto.nombre, `tipoNovedad`, inventario.cantidad, inventario.fecha, inventario.observacion FROM `inventario` INNER JOIN producto ON inventario.idProducto=producto.idProducto";
...
<p></p>
<h1>INSUMOS SIRPEC</h1>

<table >
			<tr>
				<td><b>Producto</b></td>
				<td><b>Novedad</b></td>
				<td><b>Cantidad Novedad</b></td>
				<td><b>Fecha</b></td>
...
// NOMBRE DEL ARCHIVO
$pdf->Output('FORMULARIO_INSUMOS.pdf', 'D');
