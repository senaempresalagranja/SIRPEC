...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Inventario</h1>
	</div>
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<div class="form-group">
						<div id="elemento_buscar">
							<label for="">Seleccionar Tipo Novedad</label>
						<select name="id"  style="text-transform:uppercase" onchange="mostrar_producto()" id="novedad" class="form-control">	
							<option value="Seleccionado">Seleccionado</option>
							<?php
							$connection=mysqli_connect("localhost","root","","sirpec");
$query="SELECT * FROM inventario GROUP BY tipoNovedad";
...
?>	
					...
					<label for="">Seleccionar Producto</label>
						<div id="elemento_buscar_producto">
...
function consulta_automatica() {
	...
	$("#resultado").load("consultar_inventario.php",{producto:producto,novedad:novedad})
...
var novedad=document.getElementById("novedad").value;
$("#elemento_buscar_producto").load("consultar_producto_inventario.php",{novedad:novedad})
