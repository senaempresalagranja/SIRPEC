...
$sql="SELECT `nombreFinca`, `Telefono`, `Tamano` , COUNT(estanque.idEstanque) as estanques FROM `finca`  INNER JOIN estanque ON finca.idFinca=estanque.idFinca GROUP BY finca.idFinca";
...
// NOMBRE DEL ARCHIVO
$pdf->Output('FORMULARIO_FINCAS.pdf', 'D');
