...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D5', 'NUMERO PECES')
            ->setCellValue('E5', 'PESO')
            ->setCellValue('F5', 'UNIDAD_MEDIDA')
            ->setCellValue('G5', 'OBSERVACION');
...
$query="SELECT siembra.lote, muestreo.hora, muestreo.fecha, muestreo.numerPeces, `pesoPromedio`, `unidadMedida`, muestreo.observacion FROM `muestreo` INNER JOIN siembra ON muestreo.idSiembra=siembra.idSiembra";
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('EXPORTAR_MUESTREO');
...
header('Content-Disposition: attachment;filename="exportacion_muestreos.xlsx"');
