...
$query="SELECT `idSanidad`, `idProducto`, `dosis`, `fecha`, `observacion` FROM `sanidad`";
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('EXPORTAR_SANIDAD');
...
header('Content-Disposition: attachment;filename="exportacion_sanidades.xlsx"');
