...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Consultar Finca</h1>
	</div>
		<div class="container">
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<div class="form-group">
						<div id="elemento_buscar">
							<label for="">Seleccionar Finca</label>
							<select name="id"  style="text-transform:uppercase" id="id" class="form-control">	
							<option value="Selecciona">Selecciona</option>
							<?php
							$connection=mysqli_connect("localhost","root","","sirpec");
$query="SELECT * FROM finca ORDER BY nombreFinca";
...
<input type="text" name="" id="nombre" style="text-transform:uppercase" class="form-control">
						</div>
					</div>
				</div>
				<div id="resultado" class="col-md-5"></div>
			</div>
...
function inicio() {
$("#id").change(consulta_automatica1);
$("#nombre").keyup(consulta_automatica);
...
function consulta_automatica() {
	...
	$("#resultado").load("consultar_finca.php",{nombre:nombre})
}

function consulta_automatica1() {
	
	
	var id=document.getElementById("id").value;
	$("#resultado").load("consultar_finca1.php",{id:id})
}
		</script>
</html>
