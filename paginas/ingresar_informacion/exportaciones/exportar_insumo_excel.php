...
// $objPHPExcel->setActiveSheetIndex(0)
//             ->setCellValue('A6',$producto_in )
//             ->setCellValue('B6', $novedad )
//             ->setCellValue('C6',$cantidad )
//             ->setCellValue('D6', $fecha )
//             ->setCellValue('E6',$Observacion );
...
header('Content-Disposition: attachment;filename="exportacion_insumo.xlsx"');
