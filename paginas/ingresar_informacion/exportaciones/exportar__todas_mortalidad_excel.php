...
$query="SELECT siembra.lote, mortalidad.fecha, mortalidad.Cantidad, mortalidad.observacion FROM `mortalidad` INNER JOIN siembra ON mortalidad.idSiembra=siembra.idSiembra";
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('EXPORTAR_MORTALIDAD');
...
header('Content-Disposition: attachment;filename="exportacion_mortalidades.xlsx"');
