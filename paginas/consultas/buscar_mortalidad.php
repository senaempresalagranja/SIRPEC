...
<title>Consulta Mortalidad</title>
...
<!-- ============================================================================== -->
		<h1 class="help-block text-center ">Consultar Mortalidad</h1>
	</div>
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<div class="form-group">
						<div id="elemento_buscar">
							<label for="">Seleccionar Siembra</label>
...
$query="SELECT mortalidad.idMortalidad,siembra.lote,mortalidad.fecha, mortalidad.Cantidad, mortalidad.observacion FROM mortalidad INNER JOIN siembra ON mortalidad.idSiembra=siembra.idSiembra";
...
while ($fila=mysqli_fetch_row($resource)) {
	...
	echo "<option value='$id'>Lote $nombre</option>";
 }
}
?>	
</select>
				...
				</div><div id="resultado" class="col-md-8"></div>
			</div>
</div>
...
function consulta_automatica() {
	...
	$("#resultado").load("consultar_mortalidad.php",{id:id})
}
		</script>
</html>
