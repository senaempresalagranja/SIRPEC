...
$query="SELECT siembra.lote, producto.nombre, `cantAlimento`, alimentacion.fecha, alimentacion.hora,alimentacion.obseracion FROM `alimentacion` INNER JOIN siembra ON alimentacion.idSiembra=siembra.idSiembra INNER JOIN producto ON alimentacion.idProducto=producto.idProducto";
