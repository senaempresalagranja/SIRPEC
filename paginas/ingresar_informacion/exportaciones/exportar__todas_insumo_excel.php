...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B5', 'TIPO NOVEDAD')
            ->setCellValue('C5', 'CANTIDAD ')
            ->setCellValue('D5', 'FECHA ')
            ->setCellValue('E5', 'OBSERVACION');
...
$query="SELECT  producto.nombre, `tipoNovedad`, inventario.cantidad, inventario.fecha, inventario.observacion FROM `inventario` INNER JOIN producto ON inventario.idProducto=producto.idProducto";
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('EXPORTAR_INSUMO');
...
header('Content-Disposition: attachment;filename="exportacion_insumos.xlsx"');
